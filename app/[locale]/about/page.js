      ...
      <section className="border-t border-white/10 bg-black">
        <div className="mx-auto max-w-7xl px-6 py-14">
          <div className="grid gap-6 md:grid-cols-3">
            <Stat label={locale === "da" ? "År med erfaring" : "Years of experience"} value="10+" />
            <Stat label={locale === "da" ? "Lancerede projekter" : "Projects shipped"} value="120+" />
            <Stat label={locale === "da" ? "Kundetilfredshed" : "Client satisfaction"} value="98%" />
          </div>
        </div>
      </section>
