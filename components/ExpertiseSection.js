 ...
 * - Translates headings, filter pills, A11y labels, and empty state
 * - Tech titles remain brand names (not translated)
 */
...
const MESSAGES = {
  da: {
    eyebrow: "Bedste funktioner",
    heading: "Vores teknologi.",
    empty: "Ingen teknologier tilføjet endnu.",
    categories: {
      frontend: "Frontend",
      backend: "Backend",
      mobile: "Mobil",
    ...
    aria: {
      section: "Teknologisektion",
      grid: "Teknologilogoer",
    },
  },
  en: {
    ...
    aria: {
      ...
      grid: "Technology logos",
    },
  },
};

/** ---------- Data (brands not translated) ---------- */
...
/** Use locale-independent ids so pills can display localized labels */
const CATEGORY_IDS = ["frontend", "backend", "mobile", "devops", "database", "pm", "cms"];
const TECH_MAP = {
